...
pub unsafe extern "C" fn generate_list() -> *mut SListEntry {
    ...
    {} else {
        __assert_fail(
            ...
            b"test/test-slist.c\0" as *const u8 as *const libc::c_char,
...
#[test]
fn s_test_slist_iterate_bad_remove() {
    unsafe {
