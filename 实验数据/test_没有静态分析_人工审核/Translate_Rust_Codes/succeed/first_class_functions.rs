...
fn call_composed(comp: &Composition, val: f64) -> f64 {
    // Modified: Correctly call the function pointers stored in the Composition struct
    (comp.f1)((comp.f2)(val))
}

fn main() {
    // Modified: Format the floating-point number to show more decimal places to match C output
