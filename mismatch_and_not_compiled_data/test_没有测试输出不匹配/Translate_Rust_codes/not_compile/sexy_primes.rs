...
fn print_array(a: &[i32]) {
    ...
    print!(r"\b]"); // Modified: Use raw string literals to avoid interpreting `\b` as an escape sequence
}
...
fn main() {
    ...
    print!(r"\b]\n\n"); // Modified: Use raw string literals to avoid interpreting `\b` as an escape sequence
