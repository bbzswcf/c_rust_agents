...
def process_files():
    c_code_dir = "test_noStatic_Analysis\c_codes"
    c_out_dir = "test_noStatic_Analysis\c_outputs"
    rust_code_dir = "test_noStatic_Analysis\Translate_Rust_codes"
    rust_out_dir = "test_noStatic_Analysis\Translate_Rust_outputs"
