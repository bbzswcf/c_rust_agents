...
def convert_c_to_rust(c_code: str, c_output_file: str, rust_code_file: str, rust_output_file: str) -> str:
    ...
    max_static_analysis_and_test_attempts = 7 # 可以适当的减少
    ...
    while static_analysis_and_test_count < max_static_analysis_and_test_attempts:
        ...
        print(f"编译和测试尝试")
        compile_success, error_or_mismatch_info = compile_and_test_rust(rust_code, c_output_file, rust_code_file,
                                                                        rust_output_file)
...
def process_files():
    ...
    for problem_folder in os.listdir(c_code_dir):
        ...
        # 进行编译和测试
        compile_success, mismatch_info = compile_and_test_rust(rust_code, c_out_file_path, temp_rust_file_path,
                                                               temp_rust_out_file_path)
